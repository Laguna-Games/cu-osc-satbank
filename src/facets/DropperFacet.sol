...
import "../../lib/web3/contracts/Dropper/LibDropper.sol";
import "../../lib/web3/contracts/interfaces/IERC721Mint.sol";
import "../../lib/web3/contracts/interfaces/ITerminus.sol";
import {DiamondReentrancyGuard} from "../../lib/web3/contracts/diamond/security/DiamondReentrancyGuard.sol";
import {LibDiamondMoonstream as LibDiamond} from "../../lib/web3/contracts/diamond/libraries/LibDiamondMoonstream.sol";
import "../../lib/web3/contracts/diamond/libraries/LibSignatures.sol";
    ...
    DiamondReentrancyGuard
{
    ...
    modifier onlySatBankAdmin() {
        LibAccessBadge.requireBadge("Satbank admin");
    ...
    function createDrop(
        ...
        string memory uri
    ) external onlySatBankAdmin returns (uint256) {
        require(
